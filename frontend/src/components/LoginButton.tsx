...
export function LoginButton() {
  ...
  return (
    <div className="flex gap-2 ml-4">
      ...
      <button
        onClick={() => alert('Вход через VK ID находится в разработке!')}
        className="px-4 py-2 bg-[#0077FF] hover:bg-[#005bb5] text-white text-sm font-medium rounded-md shadow-sm transition-colors flex items-center gap-2 opacity-50 cursor-not-allowed"
      >
        Войти через VK ID
      </button>
    </div>
